create database Bootcamp_exercise1_updated;
use Bootcamp_exercise1_updated;
...
where l.state_province like '%JP' or l.city like '%JP';
...
alter table jobs ADD grade_level varchar(20);
